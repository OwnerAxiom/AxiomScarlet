...
from AxiomMuzic.mongo.filtersdb import *
from AxiomMuzic.utils.filters_func import GetFIlterMessage, get_text_reason, SendFilterMessage
...
@app.on_message(filters.command('stopall', 'fstp') & admin_filter)
